...
| [`fix-xpt/`](fix-xpt/) | Native LAMMPS fix computing Two- and Three-Phase Thermodynamics (1PT/2PT/3PT) on the fly from the velocity trajectory: entropy, free energy, heat capacity and self-diffusivity at the end of each analysis window, with no velocity dump and no post-processing step. FFT and in-line multi-tau correlators, molecular decomposition, optional Kokkos/GPU styles. The LAMMPS counterpart to `py-xPT`. MIT; Zenodo [10.5281/zenodo.21456029](https://doi.org/10.5281/zenodo.21456029) (all versions). |
